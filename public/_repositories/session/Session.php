...
class Session implements ISession {
  ...
  {
    return json_decode(file_get_contents(_from_top_folder()."/_temp_database/session/$session_id.json"));
  }
  ...
  public function insert(object $session) : void
  {
    ...
    file_put_contents(_from_top_folder()."/_temp_database/session/$session_id.json", json_encode($session, JSON_PRETTY_PRINT));
  }
