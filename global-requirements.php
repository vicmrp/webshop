...
// ----- namespaces - inkludere alle klasserne ----- //
$directories = new RecursiveDirectoryIterator(_from_top_folder().'/dto');
foreach (new RecursiveIteratorIterator($directories) as $filename => $file)
{ 
  if (!is_dir($filename)) require_once $filename;  
}
...
// ----- namespaces - inkludere alle klasserne ----- //
$directories = new RecursiveDirectoryIterator(_from_top_folder().'/services');
foreach (new RecursiveIteratorIterator($directories) as $filename => $file)
{ 
  if (!is_dir($filename)) require_once $filename;  
}
...
// ----- namespaces - inkludere alle klasserne ----- //
$directories = new RecursiveDirectoryIterator(_from_top_folder().'/repositories');
foreach (new RecursiveIteratorIterator($directories) as $filename => $file)
{ 
  if (!is_dir($filename)) require_once $filename;  
}
...
// ----- namespaces - inkludere alle klasserne ----- //
$directories = new RecursiveDirectoryIterator(_from_top_folder().'/entities');
foreach (new RecursiveIteratorIterator($directories) as $filename => $file)
{ 
  if (!is_dir($filename)) require_once $filename;  
}
